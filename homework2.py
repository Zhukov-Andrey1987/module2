...
if name == 'Ola':
    opponent = 'Ola'  # Не понял зачем здесь эта строчка, как и аналогичные дальше!
    print('Hi, Ola!')
else:
    if name == 'Sofi':
        opponent = 'Sofi'
...
my_favorite_pets_and_birds = ['cat', 'wolf', 'ostrich']  # Не понятно нужно ли было исправлять здесь!
...
l = 34 # Это примеры, или нужно было исправить?
I = 43
if l > I:
    print()
O = 9
